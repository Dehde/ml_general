...
RUN conda install jupyter notebook pandas scipy scikit-learn pytorch torchvision cudatoolkit=10.0 -c pytorch
RUN pip install tifffile Shapely rasterio geopandas
...
# Set dir to start in and command to run by default
WORKDIR /home/rob/code
